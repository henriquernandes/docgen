                            ...
                            logs.map((log) => {
                                ...
                                return (
                                    <tr key={log.id}>
                                        ...
                                        <td className="py-2 px-4 border bg-purple-500">{log.corpo_envio_resposta.metodo.metodo.toUpperCase()}</td>
                                        <td className="py-2 px-4 border">{log.rota.rota}</td>
                                        <td className={`py-2 px-4 border ${(log.corpo_envio_resposta.codigo_http  >= 200 &&  log.corpo_envio_resposta.codigo_http <= 200)? 'bg-green-200' : 'bg-red-200' }`}>{log.corpo_envio_resposta.codigo_http}</td>
